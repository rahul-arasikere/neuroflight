...
#include "tflite/tensorflow/lite/kernels/internal/reference/transpose_conv.h"
...
#include "tflite/tensorflow/lite/kernels/internal/reference/integer_ops/transpose_conv.h"
