...
#include "tflite/tensorflow/lite/kernels/internal/reference/dequantize.h"
...
#include "tflite/tensorflow/lite/kernels/internal/reference/quantize.h"
#include "tflite/tensorflow/lite/kernels/internal/reference/requantize.h"
